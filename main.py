...
# never hardcoded. Locally, you can export these in your shell, or in
# Colab set them with os.environ["BOT_TOKEN"] = "..." before running.
# ============================================================================
...
def validate_config() -> bool:
    ...
    if not BOT_TOKEN or BOT_TOKEN.startswith("YOUR_") or ":" not in BOT_TOKEN:
        log("❌ BOT_TOKEN looks invalid or is still a placeholder. It should look like '123456789:AAE...'.")
        ok = False

    if not CHAT_ID or CHAT_ID.startswith("YOUR_"):
        log("❌ CHAT_ID looks invalid or is still a placeholder. Use @userinfobot or getUpdates to find it.")
        ok = False

    if not GEMINI_API_KEY or GEMINI_API_KEY.startswith("YOUR_"):
        log("❌ GEMINI_API_KEY looks invalid or is still a placeholder.")
        ok = False
